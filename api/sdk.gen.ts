 ...
 * 获取所有配置
 */
export const configControllerFindAll = <TComposable extends Composable, DefaultT = undefined>(
  options: Options<TComposable, ConfigControllerFindAllData, unknown, DefaultT>
) => {
  return (options.client ?? _heyApiClient).get<TComposable, unknown | DefaultT, unknown, DefaultT>({
    url: '/config',
    ...options
