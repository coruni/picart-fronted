    ...
    <div v-if="isLoading" class="flex flex-col lg:flex-row gap-4 md:gap-8">
      ...
      <div class="flex-1">
        ...
        <div class="bg-white dark:bg-gray-800 p-4 md:p-6 mb-4 md:mb-6">
          ...
          >
            <USkeleton class="w-24 h-24 md:w-32 md:h-32 rounded-full" />
            <div class="flex-1">
              <USkeleton class="h-6 md:h-8 w-32 mb-2" />
        ...
        <!-- 文章列表骨架屏 -->
        <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-4 gap-3 md:gap-6">
