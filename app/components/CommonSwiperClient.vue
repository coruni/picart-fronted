<template>
  <ClientOnly>
    ...
    <template #fallback>
      <div class="h-60 md:h-[480px] bg-gray-100 dark:bg-gray-900 relative overflow-hidden">
        <NuxtLinkLocale
          v-if="firstBanner"
    ...
    <div class="relative">
      <swiper-container
        ...
        class="h-60 md:h-[480px] transition-all duration-300 bg-gray-100 dark:bg-gray-900"
        :autoplay="{ delay: 3000 }"
        :slides-per-view="1"
